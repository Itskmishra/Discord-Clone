...
const ServerChannel: React.FC<ServerChannelProps> = ({
  ...
  return (
    ...
    >
      ...
      <p
        className={cn(
          "line-clamp-1 font-semibold text-xm text-zinc-500 group-hover:text-zinc-600 dark:text-zinc-400 dark:group-hover:text-zinc-300 transition",
      ...
      {channel.name === "general" && (
        <ActionTooltip label="Channel Locked">
